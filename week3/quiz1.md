...
- 답: 1. 파일을 새로 만들고 commit
      2. 원래 있던 파일을 지우고 통합한 새로운 파일을 만들어서 commit
      3. 원래있던 파일들로 commit, 안좋은일이 생기는 commit 
...
- 답: revert, (reset은 다른 사람들이 작업위치가 바뀐지도 모르고 작업하는 참사가 발생할 수 있다.)